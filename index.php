...
<body>
       ...
       <div class="sign-up">
       <a href="register.php"><input type="button" value="register" class="sign"></a> 
        <a href="login.php"><input type="button" value="log in" class="login"></a>
      </div>
      </header> 
      <main>
        <div class="mainbar">
             <h2>Dear Customer,Welcome To Our online Store</h2>
            <p><span>this is our online shop Store for PCs</span></p>
           <a href="register.php"><input type="button" value="shop now" ></a> 
        </div>
